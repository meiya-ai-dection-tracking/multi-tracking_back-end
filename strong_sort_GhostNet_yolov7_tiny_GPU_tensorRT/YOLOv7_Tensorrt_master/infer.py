...
class TRT_engine():
    ...
    def init_engine(self):
        ...
        for index in range(self.model.num_bindings):
            ...
            if self.model.binding_is_input(index) and self.dtype == np.float16:
                self.fp16 = True
        print(self.fp16, self.dtype, self.model.binding_is_input(index))
    ...
    def predict(self,img,threshold):
        ...
        print(time.time() - t11, 'detector-predict')
...
# trt_engine = TRT_engine("yolov7_tiny.engine")
