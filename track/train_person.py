# -*- coding = utf-8 -*-
# @Time: 2022/7/28 17:35
# @Author: yzx
# @Site:
# @File: train_person.py
# @Software: PyCharm
...
from deep_sort.deep_sort.deep_sort.deep.model import Net

parser = argparse.ArgumentParser(description="Train on market1501")
parser.add_argument("--data-dir", default='..\\deep_sort\\deep_sort\\deep_sort\\deep\\data', type=str)
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(checkpoint, './output/ckpt_person.t7')
